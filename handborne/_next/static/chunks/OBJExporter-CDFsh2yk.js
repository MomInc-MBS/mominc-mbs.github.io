import{Dt as e,H as t,Ot as n,d as r,ht as i,u as a}from"./three.module-eGXlaObX.js";var o=class{parse(o){let s=``,c=0,l=0,u=0,d=new n,f=new a,p=new n,m=new e,h=[];function g(e){let n=0,r=0,i=0,a=e.geometry,o=new t,f=a.getAttribute(`position`),g=a.getAttribute(`normal`),_=a.getAttribute(`uv`),v=a.getIndex();if(s+=`o `+e.name+`
...
`;c+=t}function v(e){let t=0,n=e.geometry,a=n.getAttribute(`position`),o=n.getAttribute(`color`);if(s+=`o `+e.name+`
`,a!==void 0){for(let n=0,c=a.count;n<c;n++,t++)d.fromBufferAttribute(a,n),d.applyMatrix4(e.matrixWorld),s+=`v `+d.x+` `+d.y+` `+d.z,o!==void 0&&(f.fromBufferAttribute(o,n),r.workingToColorSpace(f,i),s+=` `+f.r+` `+f.g+` `+f.b),s+=`
