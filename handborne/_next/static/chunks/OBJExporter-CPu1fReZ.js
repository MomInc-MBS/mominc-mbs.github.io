import{Dt as e,Et as t,V as n,d as r,mt as i,u as a}from"./three.module-DpYYbvTO.js";var o=class{parse(o){let s=``,c=0,l=0,u=0,d=new e,f=new a,p=new e,m=new t,h=[];function g(e){let t=0,r=0,i=0,a=e.geometry,o=new n,f=a.getAttribute(`position`),g=a.getAttribute(`normal`),_=a.getAttribute(`uv`),v=a.getIndex();if(s+=`o `+e.name+`
