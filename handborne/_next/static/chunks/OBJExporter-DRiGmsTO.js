import{Ot as e,U as t,d as n,gt as r,kt as i,u as a}from"./three.module-D5ImnpuM.js";var o=class{parse(o){let s=``,c=0,l=0,u=0,d=new i,f=new a,p=new i,m=new e,h=[];function g(e){let n=0,r=0,i=0,a=e.geometry,o=new t,f=a.getAttribute(`position`),g=a.getAttribute(`normal`),_=a.getAttribute(`uv`),v=a.getIndex();if(s+=`o `+e.name+`
