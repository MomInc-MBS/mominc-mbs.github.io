...
try{viewer=new CreatureViewer($('creatureStage'),base);applyMotion();render(initialError||'Your coach is ready');(window as any).myr5Companion={get recipe(){return recipe;},get viewer(){return viewer;},get ready(){return ready;},importRecipe:(raw:string)=>commit(importCreature(raw))};}
